...
-- Data is in branch 'domain_migratiion_experiment' under migration_energy_reteil_experiment/
-- ========================================================================
COPY FILES INTO @ENERGY_STAGE/demo_data/ FROM @ENERGY_AI_DEMO_REPO/branches/domain_migratiion_experiment/migration_energy_reteil_experiment/demo_data/;
COPY FILES INTO @ENERGY_STAGE/unstructured_docs/ FROM @ENERGY_AI_DEMO_REPO/branches/domain_migratiion_experiment/migration_energy_reteil_experiment/unstructured_docs/;

-- For local testing (alternative to Git), upload files manually:
-- PUT file:///path/to/migration_energy_reteil_experiment/demo_data/*.csv @ENERGY_STAGE/demo_data/;
-- PUT file:///path/to/migration_energy_reteil_experiment/unstructured_docs/**/* @ENERGY_STAGE/unstructured_docs/;
